...
public class GetAllPackges extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			while(resultSetObj.next()) {
				...
				Package packageFromDB = new Package(idpackages, packageName, packagePrice, packageResolution, packageWatchers, packageDescription);
				PackageList.add(packageFromDB);
			}
		...
		RequestDispatcher reqDis = request.getRequestDispatcher("AddPackage.jsp");
